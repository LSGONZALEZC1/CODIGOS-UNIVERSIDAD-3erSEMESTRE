...
console.log(Caja)
    ...
    for(let i=0; i<10; i++){
        ...
        // console.log("Nuevo 100 cromosoma con los alelos cambiados")
        // console.log(Unir_Mitades)
        ...
        CajaNuevosCromosomas.push(Unir_Mitades)
        Caja.push(Tablero)
    }
 
    console.log("Nuevos 100 Cromosomas con los nuevos cromosomas")
    console.log(CajaNuevosCromosomas)
